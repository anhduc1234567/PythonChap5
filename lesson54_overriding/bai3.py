class Account:
    ...
    def check_balance(self):
        print(f"SO DU CUA TAI KHOAN LA: {self.sodu}")
...
def creat_fake_account():
    accounts = []
    accounts.append(Account(15102004,"NGUYEN DUC ANH","1/1/2023","1/1/2030",500000000,"MB",0,1,0))
    ...
    accounts.append(Account(88880000, "LE DUC MANH", "1/1/2023", "1/1/2030", 1500000, "MB", 0, 1, 0))
    return accounts
